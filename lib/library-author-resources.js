const AUTHOR_RESOURCES = {
  jungmyeongju: {
    'self-meditation': {
      ...
      materials: [
        {
          title: '셀프 명상상담 실천안내서 모바일 열람용',
          description:
            '셀프 명상상담의 구성과 단계별 작성법, 기록 예시와 자주 묻는 질문을 확인할 수 있습니다.',
          buttonLabel: '모바일 열람용 PDF 다운로드',
          href: '/library/authors/jungmyeongju/resources/self-meditation/self-meditation-guide.pdf',
          download: 'self-meditation-guide.pdf',
        },
        {
          title: '셀프 명상상담 실천안내서 출력용',
          description:
            '셀프 명상상담의 구성과 단계별 작성법, 기록 예시와 자주 묻는 질문을 출력용 문서로 확인할 수 있습니다.',
          buttonLabel: '출력용 PDF 다운로드',
          href: '/library/authors/jungmyeongju/resources/self-meditation/self-meditation-guide-print.pdf',
          download: 'self-meditation-guide-print.pdf',
        },
        {
          title: '셀프 명상상담 일지',
          description:
            '수업 내용을 직접 따라 하며 작성할 수 있도록 마련한 출력용 실습 자료입니다.',
          buttonLabel: '일지 PDF 다운로드',
          href: '/library/authors/jungmyeongju/resources/self-meditation/meditation-practice.pdf',
          download: 'meditation-practice.pdf',
        },
      ],
      background:
...
const AUTHOR_RELATED_LINK_ORDER = {
  jungmyeongju: [
    'https://smartstore.naver.com/giniginigini/products/13736993252',
