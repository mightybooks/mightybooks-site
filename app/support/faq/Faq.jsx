...
const faqs = [
  {
    ...
    a: [
      ...
      '다만 원고를 직접 검토하는 기획출간 상담이나 문수림이 고객에게 찾아가는 대구·경북·경남 출장상담처럼 별도의 시간과 전문 검토가 필요한 서비스는 유료로 진행합니다.',
    ],
  },
  {
  ...
  },
  {
    q: '출장 상담도 가능한가요?',
    a: [
      '대구ㆍ경북ㆍ경남권은 예약제로 출장 상담 진행이 가능합니다.',
      '단, 거리와 이동 시간에 따라 출장 상담료가 달라지므로, 사전에 상담료와 일정을 안내드립니다.',
      '상담료는 현장에서 계약체결 시 계약금 또는 제작비에 포함되며, 계약으로 이어지지 않는 경우에는 출장 상담료로 처리됩니다.',
    ],
  },
