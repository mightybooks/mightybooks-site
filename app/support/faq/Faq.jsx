...
const faqs = [
  ...
  },
  {
    q: '전자책 제작도 가능한가요?',
    a: [
      '가능합니다. PDF 또는 EPUB 형태의 전자책 제작을 상담할 수 있습니다.',
      'AI 생성 도구가 많아지면서 누구나 전자책을 만들 수 있는 시대가 되었지만, 모든 전자책이 팔리거나 저자의 브랜딩 자산이 되는 것은 아닙니다.',
      '마이티북스는 단순한 파일 변환이 아니라 저자의 경험, 전문성, 이야기, 콘텐츠를 장기적으로 활용 가능한 출판 자산으로 정리하는 방향을 함께 검토합니다.',
    ],
  },
  {
    q: '제작비는 어떻게 결정되나요?',
