...
const plans = [
  { name: '베이직', price: '150만 원부터', criteria: '한 권부터 소량 제작 가능', intro: '완성된 원고를 가장 기본적인 출판 사양으로 제작하는 플랜입니다.', fit: '완성된 원고를 기본 사양의 책으로 제작하고 싶은 개인 저자에게 적합합니다.', included: ['완성 원고 확인', '기본 오탈자 및 표기 교정', '목차와 작품 순서 반영', '기본 내지 편집디자인', '기본 표지 디자인', '총 3회의 교정 및 수정', '인쇄용 최종 파일 제작', '출간 및 인쇄 제작 진행'], extra: ['에세이·산문 윤문', '사진·삽화 보정', '복잡한 도표나 특수 편집', '특수 용지 및 후가공', '추가 수정', 'ISBN 발급 및 서점 유통'] },
...
function ContactButtons() {
  ...
  return <><div className={styles.contactRow}>
    ...
    <GeneralInquiryTrigger className={styles.ctaBtnGhost} source="시집 제작 페이지">이메일 문의</GeneralInquiryTrigger>
    ...
    <section className={styles.hero}>
      ...
      <div className={styles.heroInner}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubcopy}>문집과 에세이 제작도 함께 진행하며, 단 한 권의 소량 인쇄부터 정식 출간과 서점 유통까지 안내합니다. 대구·경북·경남은 대면 상담이 가능하고, 원하는 경우 지역과 관계없이 처음부터 비대면으로 진행할 수 있습니다.</p>
        ...
        <div className={styles.heroVisual}>
          ...
          <div className={styles.priceNote}><strong>기본 제작비 150만 원부터</strong><span>원고 분량, 판형, 페이지 수, 디자인 난이도, 인쇄 부수와 후가공에 따라 최종 견적이 달라집니다.</span></div>
