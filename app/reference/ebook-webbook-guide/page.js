...
export default function EbookWebbookGuidePage() {
  return <div className={styles.wrap}>
    ...
    <main className={styles.content}>
      ...
      <div className={styles.cta}><div className={styles.ctaText}>전체 원고와 배포 방식, 독자의 이용 환경을 전달하면 적합한 형식과 제작 범위를 검토할 수 있습니다.</div><div className={styles.ctaBtns}><Link href="/business/epub" className={styles.ctaBtn}>전자책·웹북 제작 서비스 보기</Link><Link href="/business/ebook-to-print" className={styles.ctaBtnGhost}>전자책·PDF를 종이책으로 제작하기</Link><Link href="/business/epub#webbook-case" className={styles.ctaBtnGhost}>실제 웹북 제작 사례 보기</Link><Link href="/support/diagnosis" className={styles.ctaBtnGhost}>현재 원고에 적합한 형식 상담하기</Link></div></div>
    </main>
  </div>
}
