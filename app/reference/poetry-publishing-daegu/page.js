  ...
  '@graph': [
    {
      ...
      mainEntityOfPage: 'https://mightybooks.kr/reference/poetry-publishing-daegu',
      author: { '@type': 'Organization', name: '마이티북스' },
      publisher: { '@type': 'Organization', name: '마이티북스', url: 'https://mightybooks.kr' },
    },
    {
      '@type': 'BreadcrumbList',
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 4, name: '대구 시집 제작 기준', item: 'https://mightybooks.kr/reference/poetry-publishing-daegu' },
      ],
    },
    ...
    <div className={styles.wrap}>
      ...
      <main className={styles.content}>
        ...
        <section className={styles.section}>
          ...
          <p>마이티북스는 시집의 기획·편집·디자인·종이책 제작을 수행하며 문집과 감성 에세이도 함께 제작합니다. 장미와 여우는 마이티북스가 운영하는 문예 출간 브랜드이며, 이 브랜드로 출간한 시집에는 《새들이 울었던 자리가 있다》, 《마하의 시간을 살다》, 《동성로 낭만 다이어리》, 《겨울 지나 봄으로》와 《폭염 지나 결실로》가 있습니다.</p>
